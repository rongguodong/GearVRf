...
public class SampleCubeScript extends GVRScript {
    ...
    public void onInit(GVRContext gvrContext) {
        ...
        mFrontFace = new GVRSceneObject(gvrContext, CUBE_WIDTH, CUBE_WIDTH,
                new GVRAndroidResource(mGVRContext, R.drawable.front));
        mFrontFace.setName("front");
        scene.addSceneObject(mFrontFace);
        mFrontFace.getTransform().setPosition(0.0f, 0.0f, -CUBE_WIDTH * 0.5f);

        mFrontFace2 = new GVRSceneObject(gvrContext, CUBE_WIDTH, CUBE_WIDTH,
                new GVRAndroidResource(mGVRContext, R.drawable.front));
        ...
        mFrontFace3 = new GVRSceneObject(gvrContext, CUBE_WIDTH, CUBE_WIDTH,
                new GVRAndroidResource(mGVRContext, R.drawable.front));
        ...
        GVRSceneObject backFace = new GVRSceneObject(gvrContext, CUBE_WIDTH,
                CUBE_WIDTH,
                new GVRAndroidResource(mGVRContext, R.drawable.back));
        ...
        GVRSceneObject leftFace = new GVRSceneObject(gvrContext, CUBE_WIDTH,
                CUBE_WIDTH,
                new GVRAndroidResource(mGVRContext, R.drawable.left));
        ...
        GVRSceneObject rightFace = new GVRSceneObject(gvrContext, CUBE_WIDTH,
                CUBE_WIDTH, new GVRAndroidResource(mGVRContext,
                        R.drawable.right));
        ...
        GVRSceneObject topFace = new GVRSceneObject(gvrContext, CUBE_WIDTH,
                CUBE_WIDTH, new GVRAndroidResource(mGVRContext, R.drawable.top));
        topFace.setName("top");
        ...
        GVRSceneObject bottomFace = new GVRSceneObject(gvrContext, CUBE_WIDTH,
                CUBE_WIDTH, new GVRAndroidResource(mGVRContext,
                        R.drawable.bottom));
        ...
        return new GVRScreenshot3DCallback() {
            ...
            public void onScreenCaptured(Bitmap[] bitmapArray) {
                Log.d("SampleActivity",
                        "Length of bitmapList: " + bitmapArray.length);
